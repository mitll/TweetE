...
Description: This script is an example of using pyTweet to create a Twitter data set with depth first sampling for
hashtag cascades.
"""
...
def main():
    ...
    # Build network using the cascade sampling method
    depth_first_sampling.depth_first_cascade_search(user_seed=username_seed,
                                       tl_start_date=tl_start_date,
                                       tl_end_date=tl_end_date,
                                       postgres_params=postgres_params,
                                       host=host,
                                       port=port,
                                       save_dir=save_params,
                                       hop_limits=hop_out_limits)
